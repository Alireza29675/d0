    ...
    _createClass(D0, [{
        ...
        value: function midPoint(point) {
            ...
            this.each(function (index, i) {
                return _this2.d(index, i / (_arguments.length + 1));
            });
            return this;
        }
        ...
        value: function multiply(toWhat) {
            ...
            try {
                var _loop = function _loop() {
                    ...
                    if (toWhat instanceof D0) _this4.eachWith(toWhat, function (index, i, j) {
        ...
        value: function divide(fromWhat) {
            ...
            try {
                var _loop2 = function _loop2() {
                    ...
                    if (fromWhat instanceof D0) _this5.eachWith(fromWhat, function (index, i, j) {
                        return _this5.d(index, i / j);
                    });else _this5.each(function (index, i) {
        ...
        value: function abs() {
            ...
            return this.each(function (index, value) {
                return _this6.d(index, Math.abs(value));
            });
        }
        ...
        value: function distanceToOrigin() {
            var sigmaSquares = 0;
            this.each(function (index, i) {
                return sigmaSquares += Math.pow(i, 2);
            });
